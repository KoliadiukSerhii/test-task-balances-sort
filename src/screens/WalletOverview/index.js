					...
					<div className={styles.line}>
						<div className={styles.details}>
							...
							<div className={styles.currency}>
								<div className={styles.number}>{isBalanceShown ? availableBalance[walletType].btc : '**********'}</div>
								<div className={cn('category-green', styles.category)}>BTC</div>
							</div>
							<div className={styles.price}>${isBalanceShown ? availableBalance[walletType].usdt : '******'}</div>
						</div>
